...
//Code Here
for (c=listOfNumbers.length; c>0; c--) {
  if (listOfNumbers[c] % 3 === 0) {
    console.log(listOfNumbers[c], "is divisible by 3.")
  }
}
...
//Code Here
for (d = letters.length; d >0; d--) {
  console.log(letters[d-1])
}
...
switch (letterGrade){
  ...
  case "D":
    ...
    break
  case "F":
    console.log("The student if failling.")
    break
  default:
...
let e = 100
    while (e> 0) {
        if (e%5 === 0 && e%3 === 0){
            // (i%15 === 0) accomplishes same task simplierly
